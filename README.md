...
```text
to-java.xsl              76499  42.17%
classes.xsl              54757  30.19%
set-locators.xsl         14547  8.02%
set-original-names.xsl   9101   5.02%
attrs.xsl                6685   3.69%
data.xsl                 6048   3.33%
tests.xsl                4623   2.55%
package.xsl              4584   2.53%
anonymous-to-nested.xsl  4559   2.51%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-07-23 at 23:21,
on Linux with 4 CPUs.
The total is 181403 milliseconds.
...
[benchmark-gha]: https://github.com/l3r8yJ/eo/actions/runs/16483759038
